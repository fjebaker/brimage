...
class GlitchVideo(_VidIO):
    ...
    def _do_mapping(self, Overlay):
        ...
        algorithm = Overlay(feed, rinit=self._rinit, ginit=self._ginit, binit=self._binit)
        ...
        with self.output(self._out_path) as i_stream:
            ...
            for frame, i_time, o_time in i_stream:
                ...
                # call method
                new_frame = algorithm.map_algorithm(*self.algol_args, **self.algol_kwargs)
