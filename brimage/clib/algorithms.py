...
class MonochomeCanvas(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, MonochomeCanvas, name, value)
    __swig_getmethods__ = {}
...
def random_walk_monochrome(reference: 'MonochomeCanvas', canvas: 'MonochomeCanvas', x_init: 'int', y_init: 'int') -> "void":
...
def random_walk_rgb(reference: 'RGBCanvas', canvas: 'RGBCanvas', x_init: 'int', y_init: 'int') -> "void":
